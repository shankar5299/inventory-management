...
export const StatCard = ({ dateRange, details, primaryIcon, title }: Props) => {
        ...
        <div className="md:row-span-1 xl:row-span-2 bg-white col-span-1 shadow-md rounded-2xl flex flex-col justify-between">
            ...
            <div>
                <div className="flex justify-between items-center mb-2 px-5 pt-4">
                    ...
                    <span className="text-xs text-green-400">{dateRange}</span>
                </div>
                <hr />
            </div>
                        ...
                        <React.Fragment key={index}>
                            <div className="flex items-center justify-between my-4">
                                ...
                                <div className="flex items-center">
                                    <detail.IconComponents className={`size-4 mr-1 ${getChangeColor(detail.changePercentage)}`} />
